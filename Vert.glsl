    ...
    if(rzutowanie == mat4(0.0f))
    {
        if(transformacja == mat4(0.0f))
        {
            if(widok == mat4(0.0f))
                ...
                gl_Position = widok * vec4(position.x, position.y, position.z, 1.0);
        }
        else
        {
            if(widok == mat4(0.0f))
                ...
                gl_Position = widok * transformacja * vec4(position.x, position.y, position.z, 1.0);
        }
    ...
    else
    {
        if(transformacja == mat4(0.0f))
        {
            if(widok == mat4(0.0f))
                ...
                gl_Position = rzutowanie * widok * vec4(position.x, position.y, position.z, 1.0);
        }
        else
        {
            if(widok == mat4(0.0f))
                ...
                gl_Position = rzutowanie * widok * transformacja * vec4(position.x, position.y, position.z, 1.0);
        }
